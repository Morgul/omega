...
omega-wfApp.prototype.requestHandler = function(request, response)
{
...
omega-wfApp.prototype.staticHandler = function(request, response)
{
    this.static.serve(request, response);
}; // end staticHandler

omega-wfApp.prototype.channel = function(channel)
{
    return this._io.of(channel);
}; // end channel

omega-wfApp.prototype.loadConfig = function(filename)
{
    this._configMan.load(filename);
}; // end loadConfig

omega-wfApp.prototype.listen = function(port)
{
    port = port || 8080;
